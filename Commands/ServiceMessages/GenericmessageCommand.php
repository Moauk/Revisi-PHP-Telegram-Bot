...
use Longman\TelegramBot\Extensions\ReplyExtensio;
...
class GenericmessageCommand extends SystemCommand
{
     ...
     * @var string
     */
    protected $description = 'Controlador genèric de missatges';
    ...
    public function execute(): ServerResponse
    {
        ...
        $resposta = ReplyExtensio::reply($message, $this->telegram->getDownloadPath());
