...
try {
    ...
    Longman\TelegramBot\TelegramLog::initialize(
        ...
        new Monolog\Logger('telegram_bot_updates', [
            (new Monolog\Handler\StreamHandler($config['logging']['update'], Monolog\Logger::INFO))->setFormatter(new Monolog\Formatter\LineFormatter('[%datetime%] %message%' . PHP_EOL, 'd/m/Y G:i')),
        ])
    );
